...
var hideAndShowAdvanceFilterBasedOnMeasure = function (key, val) {
    if (val == "Measures") {
        ...
        if (guestListForAnalysis.indexOf(measureText) > -1) {
            ...
            $(".centerAlign").css("left", "51% !important");
        }
            ...
            $(".centerAlign").css("left", "50% !important");
        }
...
var establishmentAndMeasureValidation = function () {
    ...
    if (selectedEle < 3) {
        showMaxAlert("Please make minimum 3 selections for Metric Comparisons");
        $(".lft-ctrl3").hide();
        $(".lft-popup-col").hide();
        reset_img_pos();
    ...
    if (selectedEle1 < 3) {
        showMaxAlert("Please make minimum 3 selections for Measures");
        $(".lft-ctrl3").hide();
        $(".lft-popup-col").hide();
        reset_img_pos();
        $(".master-lft-ctrl").parent().css("background", "none");
